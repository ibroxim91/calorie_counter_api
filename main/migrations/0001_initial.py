# Generated by Django 4.2 on 2024-02-02 10:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume', models.CharField(choices=[('dona', 'dona'), ('pors', 'pors'), ('100 gram', '100 gram')], max_length=25, verbose_name='Hajmi')),
                ('kkl', models.PositiveIntegerField(default=0)),
                ('adder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='foods', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='History',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kkl', models.PositiveIntegerField(default=0)),
                ('food_volumes', models.JSONField(blank=True, null=True)),
